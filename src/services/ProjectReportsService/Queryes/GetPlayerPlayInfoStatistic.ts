...
import {PlayerPlayInfoStatistic, PlayInfoStatisticQueryParams} from "../types";

export type GetPlayerPlayInfoStatisticResponse = {
    logs: (
        Omit<PlayerPlayInfoStatistic, "player"> &
        {
...
export const GetPlayerPlayInfoStatisticResponseDTOFactory = (data: GetPlayerPlayInfoStatisticResponse["logs"]): PlayerPlayInfoStatistic[] => {
...
export class GetPlayerPlayInfoStatistic implements GraphQLQuery<PlayInfoStatisticQueryParams> {
    readonly query: any;
