...
export class AreaToVolumeConverter implements _ConvertValueBetweenUnitsProcessorInterface {
    ...
    constructor(unitGroups: UnitGroupData[]) {
        this.baseValueProcessor = new _ConvertationBaseProcessor(
            ...
            (sourceBaseValue, params) => sourceBaseValue * params.normativeHeightOfStacking,
            params => params.sourceUnit.unit_group === "3" && params.targetUnit.unit_group === "2",
        )
    }
