...
export class WeightToContainerConverter implements _ConvertValueBetweenUnitsProcessorInterface {
    ...
    constructor(unitGroups: UnitGroupData[]) {
        this.baseValueProcessor = new _ConvertationBaseProcessor(
            unitGroups.find(g => g.id === "6") as UnitGroupData,
            ...
            params => params.sourceUnit.unit_group === "1" && params.targetUnit.unit_group === "6",
        )
    }
