...
export class WeightToPalletConverter implements _ConvertValueBetweenUnitsProcessorInterface {
    ...
    constructor(unitGroups: UnitGroupData[]) {
        this.baseValueProcessor = new _ConvertationBaseProcessor(
            ...
            (sourceBaseValue, params) => (
                sourceBaseValue / this.densityConverter.ConvertToBaseDensity(params.density, params.densityUnitFrom, params.densityUnitTo) * params.normativeHeightOfStacking
            ),
            params => params.sourceUnit.unit_group === "1" && params.targetUnit.unit_group === "4",
        )
    }
