...
export class AreaToWeightConverter implements _ConvertValueBetweenUnitsProcessorInterface {
    ...
    constructor(unitGroups: UnitGroupData[]) {
        this.baseValueProcessor = new _ConvertationBaseProcessor(
            ...
            params => params.sourceUnit.unit_group === "3" && params.targetUnit.unit_group === "1",
        )
    }
