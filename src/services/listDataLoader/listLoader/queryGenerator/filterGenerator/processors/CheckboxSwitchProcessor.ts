...
/**
 * Процессор генерации подзапросов фильтрации для логических значений
 */
export class CheckboxSwitchProcessor implements FilterGeneratorProcessor<"Checkbox" | "Switch"> {
    ...
    GenerateFilter<K extends keyof Schemas, F extends keyof Schemas[K]["fields"]>(
        params: FilterGeneratorProcessorParams<"Checkbox" | "Switch", K, F>
    ): string {
