...
/**
 * Процессор для обработки строковых отношений
 */
export class StringRelationProcessor<T, field extends keyof T> implements DataConverterProcessorInterface<T, field> {
