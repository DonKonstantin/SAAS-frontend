import { GetChannelsForPlayerCodesQueryResponse } from "./Queries/GetChannelsForPlayerCodes";
...
export interface PlayerCodeServiceInterface {
   ...
   */
  getPlayersForPlayerCodes: (
    projectId: string,
    playerCodeIDs: string[]
  ) => Promise<GetChannelsForPlayerCodesQueryResponse>;

  /**
   * Деактивирует код плеера
   */
  deactivatePlayerCode: (playerCode: string[]) => Promise<boolean>;
}
