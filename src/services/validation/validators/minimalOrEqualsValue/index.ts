 ...
 * @param parameters
 */
export const MinimalOrEqualsValueValidator: ValidatorFactory<Params> = (parameters: Params) => {
    if (!parameters.errorMessage) {
        parameters.errorMessage = `Минимальное значение должно быть больше или равно ${parameters.minimalValue}`
    }
