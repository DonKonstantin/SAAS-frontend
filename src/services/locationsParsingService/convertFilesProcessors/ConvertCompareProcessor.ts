...
/**
 * Процессор для обработки объединения колонок
 */
export class ConvertCompareProcessor implements ConvertFilesToBaseLocationToImportProcessorInterface {
    /**
