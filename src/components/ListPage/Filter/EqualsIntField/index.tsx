...
/**
 * Поле фильтрации числового значения
 */
export class EqualsIntField extends React.Component<FilterFieldProperties<"EqualsInt", any, any>, FieldState> {
    /**
     * Конструктор компонента
     * @param props
     */
    constructor(props: FilterFieldProperties<"EqualsInt", any, any>) {
        super(props);
        this.state = {
     ...
     */
    componentDidUpdate(
        prevProps: Readonly<FilterFieldProperties<"EqualsInt", any, any>>,
            ...
            <Tooltip title={`Фильтрация по полному соответствию значения поля "${this.props.configuration.title}"`}>
                <TextField
                    ...
                    onChange={e => {
                        ...
                        let val: number | null = fieldValue.length > 0 ? parseInt(fieldValue, 0) : null;
