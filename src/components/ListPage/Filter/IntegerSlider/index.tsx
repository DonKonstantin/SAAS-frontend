...
// Свойства компонента
interface FieldProps extends FilterFieldProperties<"IntegerSlider", any, any> {
    classes: {
        label: string
        slider: string
    }
 ...
 */
class IntegerSlider extends React.Component<FieldProps, FieldState> {
    /**
...
export default withStyles(styles)(IntegerSlider)