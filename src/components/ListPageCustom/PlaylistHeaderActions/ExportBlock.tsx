...
import { DropZoneAreaLoadingBlocker } from "../../DropZoneAreaLoadingBlocker"
 ...
 * @returns
 */
const ExportBlock: FC<Props> = ({ isLoading, onDrop, onClose }) => {
  const { t } = useTranslation();

  return (
    <Fragment>
      <DropZoneAreaLoadingBlocker isBlocked={isLoading}>
        <DropZoneArea
          customInputText={t(
