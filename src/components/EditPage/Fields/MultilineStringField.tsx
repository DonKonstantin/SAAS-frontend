...
// Поле ввода многострочного строкового значения
const MultilineStringField: FC<EditFieldProperties> = (props) => {
...
export default React.memo(MultilineStringField, (prevProps, nextProps) => {
