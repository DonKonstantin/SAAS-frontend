...
const StringFieldWithoutLabel: FC<EditFieldProperties> = props => {
    ...
    const {
        ...
        values,
        validation,
        fieldConfig: {isVisible = () => true, startIcon: IconComponent, validation: validators = []},
        onChangeFieldValue,
    } = fieldData
...
export default React.memo(StringFieldWithoutLabel, (prevProps, nextProps) => {
