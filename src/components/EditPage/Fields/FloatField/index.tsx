...
export const FloatField: TFieldsFactory<Params> = (params: Params = {}) => {
        ...
        renderField() {
            ...
            return (
                <FormControl variant="outlined" fullWidth>
                    <InputLabel error={!!this.props.error} classes={{outlined: this.props.classes.label}}
                                htmlFor={`outlined-adornment-${this.props.configuration.field}`}>{this.props.configuration.title}</InputLabel>
                    <OutlinedInput
