...
import RelationWithSearchFieldContainer
    from "../../../../containers/EditPage/Fields/RelationWithSearchField/RelationWithSearchFieldComponent";
import {Collection} from "../../../../services/types";
import {LocalizedField} from "./RelationWithSearchFieldComponent";
...
export const RelationWithSearchField: TFieldsFactory<Params<keyof Schemas>> = (
    ...
    class Component<T extends keyof Schemas> extends React.Component<EditFieldProperties<T, any>> {
        render() {
            // @ts-ignore
            const Container: React.ComponentType<any> = RelationWithSearchFieldContainer;
            return (
                <Container
    ...
    return {
        ...
        additionData: async (values: EntityValues<any>, __: any, token?: string) => {
            ...
            const selected = await service.LoadEntitiesById({
                ...
                ids: (values[params.fieldCode] ? [values[params.fieldCode]] : []) as any[],
