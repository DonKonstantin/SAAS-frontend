...
export const breadcrumbs: { (): BreadcrumbsStructure } = () => {
  return {
    ...
    "/domain/[domainId]/project/[projectId]/project_playlist": {
      breadcrumb: "project-playlists.list.breadcrumb",
      link: () => {
        const { domain, project } = getCurrentState();

        return {
          href: "/domain/[domainId]/project/[projectId]/project_playlist",
          as: `/domain/${domain}/project/${project}/project_playlist`,
        };
      },
    },
    "/domain/[domainId]/project/[projectId]/project_playlist/edit/[entityId]": {
      breadcrumb: "project-playlists.edit.breadcrumb",
      link: ({ entityEditPrimaryKey }) => {
        const { domain, project } = getCurrentState();

        return {
          href: "/domain/[domainId]/project/[projectId]/project_playlist/edit/[entityId]",
          as: `/domain/${domain}/project/${project}/project_playlist/edit/${entityEditPrimaryKey}`,
        };
      },
    },
