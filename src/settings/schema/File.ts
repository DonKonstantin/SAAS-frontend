...
const file: Schema = {
    fields: {
        ...
        license_type: {
            ...
            enum: {
                variants: {
                    rao_voice: "pages.mediaLibrary.field.license_type-enum.rao_voice",
                    sparx: "pages.mediaLibrary.field.license_type-enum.sparx",
                    amurco: "pages.mediaLibrary.field.license_type-enum.amurco"
                }
            }
        },
        lyricist: {
