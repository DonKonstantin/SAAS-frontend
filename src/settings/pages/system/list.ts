...
export interface ListPageConfiguration<T extends keyof Schemas> {
    ...
    header: string                              // Заголовок страницы
    ...
    readPermission: string                      // Разрешение, необходимое для просмотра
    editPermission: string                      // Разрешение, необходимое для редактирования
    ...
    addPageUrl: {href: string, as?: string}     // Ссылка на страницу добавления
